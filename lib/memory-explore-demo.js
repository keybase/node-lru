...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        function printUsage(stage, ms, ops) {
            var perItem = process.memoryUsage().heapUsed / lru.size();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    INSERTS = 1000 * 1000;
                    STORAGE = 1000 * 1000;
                    lru = new index_1.default({ maxAgeMs: Infinity, maxStorage: STORAGE });
                    printUsage('startup', 0, 0);
                    _a.label = 1;
                case 1:
                    if (!true) return [3 /*break*/, 5];
                    return [4 /*yield*/, addTest()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, lookupTest()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, removeTest()];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 1];
